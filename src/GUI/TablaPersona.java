...
/**
 * @author Gael Asahi Jimenez Gomez
 * @version (3/19/2024)
 */

public class TablaPersona extends JFrame{
    ...
    public TablaPersona() {
        ...
        List<Object[]> personasData = dataAccess.conexionConsultaDatos(consulta, DataAccess.TABLA_PERSONA);
    ...
    public static void main(String args[]) {
        TablaPersona se = new TablaPersona();
        se.setVisible(true);
    }
